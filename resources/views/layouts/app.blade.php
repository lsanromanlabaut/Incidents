...
<body>
    <div id="app">
            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm fixed-top">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        {{ config('app.name', 'Incidents Manager') }}
                    </a>
        ...
        <section id="body-section" style="background: url({{asset('img/background.jpg')}}) repeat">
        ...
        <footer class="container-fluid fixed-bottom bg-dark shadow-sm text-light">
            <div class="row">
                <div class="col-md-12 p-2 ">
                    <p class="text-center">&copy; Copyright 2019 - Incidents Manager</p>
                </div>
            </div>
        </footer>
    </div>
